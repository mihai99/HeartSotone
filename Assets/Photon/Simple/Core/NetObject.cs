...
#else
        // Fake references just to placehold if Pun isn't installed yet
        public static Dictionary<int, NetObject> activeControlledNetObjs;
        public static Dictionary<int, NetObject> activeOtherdNetObjs;
#endif
...
#else
		public int ViewID { get { return 0; } }
#endif
